...
DEFAULT TEMPLATES
////////////////////////////////////////////////////////////////////////////////
Import default fanclub templates
*/

Fanclub.templates = {
	account: require('./templates/account.hbs'),
	affiliates: require('./templates/affiliates.hbs'),
	contest: require('./templates/contest.hbs'),
	contests: require('./templates/contests.hbs'),
	customer: require('./templates/customer.hbs'),
	errors: require('./templates/errors.hbs'),
	event: require('./templates/event.hbs'),
	events: require('./templates/events.hbs'),
	order: require('./templates/order.hbs'),
	orders: require('./templates/orders.hbs'),
	password_reset: require('./templates/password_reset.hbs'),
	plan: require('./templates/plan.hbs'),
	plans: require('./templates/plans.hbs'),
	receipt: require('./templates/receipt.hbs'),
	subscription: require('./templates/subscription.hbs'),
	subscriptions: require('./templates/subscriptions.hbs')
};

module.exports = sparkart;